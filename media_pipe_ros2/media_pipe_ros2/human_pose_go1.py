...
class PosePublisher(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(Image, '/go1/camera/left/image_raw', self.getimage_callback, 10)  
    ...
    def getimage_callback(self, data):
        ...
        if results_p.pose_landmarks != None:
            index_pose = 0
            for pose_landmarks in (results_p.pose_landmarks.landmark):
